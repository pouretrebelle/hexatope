...
class Demo extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <div style={{position: 'absolute', left: '30%', top: '30%', width: 2, height: 2, border: '1px solid crimson', zIndex: 100}} />
        <div style={{position: 'absolute', left: '70%', top: '30%', width: 2, height: 2, border: '1px solid crimson', zIndex: 100}} />
        <NewsletterPopup />
        <DemoSettings
          system={system}
